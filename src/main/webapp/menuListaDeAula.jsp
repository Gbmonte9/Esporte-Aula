...
<head>
<meta charset="UTF-8">
<title>Menu Lista de Aula</title>
<link rel="stylesheet" type="text/css" href="css/menuListaDeAula.css">
...
<body>
										...
										<tbody>
											...
											<tr>
												...
												<td><button type="button" class="btn btn-warning"
														id="inputAulaId" name="aulaId"
														onclick="SvEditarAula('<%=aula.getId()%>')"
														value="<%=aula.getId()%>">Editar</button></td>
											</tr>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<h1 class="modal-title fs-5" id="staticBackdropLabel">Deseja excluir Aula?</h1>
															<button type="button" class="btn-close"
																data-bs-dismiss="modal" aria-label="Close"></button>
														</div>
														<div class="modal-body">Você tem certeza que deseja excluir Aula?</div>
	...
	<script>
		function SvExcluirAula(aulaId) {
			...
			formulario.action = "SvExcluirAula";
			formulario.method = "get";
	...
	<script>
		function SvEditarAula(aulaId) {
			var formulario = document.createElement("form");

			formulario.action = "SvMenuEditarAula";
			formulario.method = "get";
			formulario.id = "inputAulaId";
