...
<link rel="stylesheet" type="text/css" href="css/cadastrarProfessor.css">
...
<body>
    ...
    <div class="container text-center">
      <div class="row">
        <div class="col">
          ...
          <form action="SvCadastrarProfessor" method="post">
            ...
            <div class="container my-5" >
                ...
                <div class="row justify-content-sm-center " >
                    ...
                    <% if (alertMsg != null && !alertMsg.isEmpty()) { %>
                      	...
                      	<% if (alertMsg.equals("Professor cadastrado com Sucesso.")) { %>
    ...
    if (alertMsg && alertMsg.includes("Professor cadastrado com Sucesso.")) {
        limparCampos();
    }
	</script>
    <script>
